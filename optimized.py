...
from query import loadData,deleteData,getStudyRegion,createRegionalTable,deleteRegionalTable,getRectangleArea,makeClusters
...
def EnumnerateRectangle():
    ...
    clusters = makeClusters(H,2)
    print(len(clusters))
    for i,j,k,l in clusters:
